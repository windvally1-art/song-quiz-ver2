...
const SONGS = {
  ...
  TWICE: [
    ...
    {
      title: 'TAKEDOWN',
      previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/cb/b4/69/cbb469fa-3cf8-2ab1-1cfa-03334179f1e9/mzaf_8961451398364908651.plus.aac.p.m4a',
      trackViewUrl: 'https://music.apple.com/kr/album/takedown-jeongyeon-jihyo-chaeyoung/1820264137?i=1820264142',
      clipStart: 15,
      lineDurations: [3, 3.5, 2, 1.5],
      lyrics: [
      ...
      blankText: '칼을 새겨놔',
      fullLine: '칼을 새겨놔',
      choices: ['칼을 새겨놔', '선을 새겨놔', '칼을 갈아놔', '칼을 꺼내놔'],
    },
  ],
  ...
  GIDLE: [
    ...
    },
    {
      ...
      previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/5f/07/4c/5f074c80-f166-ff89-a1a8-f06fdc465f0c/mzaf_2261180378649156450.plus.aac.p.m4a',
      trackViewUrl: 'https://music.apple.com/kr/album/%EB%82%98%EB%8A%94-%EC%95%84%ED%94%88-%EA%B1%B4-%EB%94%B1-%EC%A7%88%EC%83%89%EC%9D%B4%EB%8B%88%EA%B9%8C/1727258590?i=1727258596',
      clipStart: 3,
      lineDurations: [4.5, 5.5],
      lyrics: [
        '뭔가 잊고 온 게 있는 것 같아',
        '괜히 이상하게 막 울 것만 같고',
      ],
      blankLine: 1,
      blankText: '괜히 이상하게',
      fullLine: '괜히 이상하게 막 울 것만 같고',
      choices: ['괜히 이상하게', '괜히 속상하게', '딱히 이상하게', '괜히 삼상하게'],
    },
  ],
  ...
  ILLIT: [
    ...
    {
      title: "It's Me",
      previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/08/ae/11/08ae11aa-40b1-231d-4013-12ca6de70701/mzaf_12606446026212796138.plus.aac.p.m4a',
      trackViewUrl: 'https://music.apple.com/kr/album/its-me/1887194024?i=1887194026',
      clipStart: 20,
      lineDurations: [2, 1.5, 2, 1.5, 3],
      lyrics: [
      ...
      blankLine: 2,
      blankText: '수수방관',
      fullLine: '수수방관 like tortilla',
      choices: ['수수방관', '하하호호', '세옹지마', '수수깡집'],
    },
  ],
  ...
  LESSERAFIM: [
    ...
    {
      title: 'HOT',
      previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/d0/46/5e/d0465e7a-48c9-4863-71b4-dcf3732be2ed/mzaf_16343066430882034672.plus.aac.p.m4a',
      trackViewUrl: 'https://music.apple.com/kr/album/hot/1799278610?i=1799278617',
      clipStart: 20,
      lineDurations: [3, 3.5, 1, 2.5],
      lyrics: [
        '마치',
        '영원함 속 날아오를 불사조같이',
        '넌 마치',
      ...
      blankLine: 3,
      blankText: '기적 같은 걸',
      fullLine: '기적 같은 걸 내게 또 꿈꾸게 하지',
      choices: ['기적 같은 걸', '주작 같은 걸', '기적 같은 보이', '기척 같은 걸'],
    },
  ],
