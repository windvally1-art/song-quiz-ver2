...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .site-logo-wrap { text-align: center; padding-top: 16px; }
  .site-logo { max-width: 260px; width: 70%; height: auto; display: block; margin: 0 auto; }
  ...
  return (
    <div className="screen">
      <div className="site-logo-wrap">
        <img src="/header-logo.jpg" alt="Arin Korean Lab" className="site-logo" />
      </div>
